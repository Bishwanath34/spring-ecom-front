...
const UpdateProduct = () => {
    ...
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `https://spring-ecom-server.onrender.com/api/product/${id}`
        );

        setProduct(response.data);
      
        const responseImage = await axios.get(
          `https://spring-ecom-server.onrender.com/api/product/${id}/image`,
          { responseType: "blob" }
        );
  ...
  console.log("formData : ", updatedProduct)
    axios
      .put(`https://spring-ecom-server.onrender.com/api/product/${id}`, updatedProduct, {
        headers: {
